    ...
    <header class="header">
        <div class="top-bar">
            <div class="logo-container">
                <a href="dashboard.php"><img src="../assets/omniphar.png" alt="logo" class="logo"></a>
            </div>
            ...
            <div class="icon-container">
                <table class="tbl">
                    <tr>
                        ...
                        <td id="profile"> &nbsp;<a href = "admin_profile.php"><img src="<?php echo $_SESSION['photo'];?>" alt="" class=""></a></td>
                    </tr>
                </table>
        </div>
    </header>
