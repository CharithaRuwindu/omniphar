...
<body>
    ...
    <!--content-->
    <div class="cart">
        <img src="assets/omniphar.png" alt="med" class="medimg">
        <div class="meddetails">
            <p> <b>FORCEVAL CAP 30S</b></p>
            <p> <b>LKR  3800</b></p>
                ...
                <h2>Contact Us</h2>
                    <div class="cont">
                        <div class="place">
                            ...
                            <span class="text"> Colombo 5, Srilanka</span>
                        </div>
                        <div class="phone">
                            <span class="fas fa-phone-alt"></span>
                            <span class="text"> 011-112233444</span>
                        </div>
                        <div class="email  ">
                            <span class="fas fa-envelope"></span>
                            <span class="text"> OMNIphar@gmail.com</span>
                        </div>
                    </div>
            </div>

            <div class="right box">
                <img src="assets/logo.jpeg" alt="logo" class="footerlogo">
            </div>
        </div>
        <div class="outer-footer">
            <p><b>Copyright &copy; OMNIphar.  All Rights Reserved</b></p>
        </div>
    </footer>
