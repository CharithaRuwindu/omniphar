<?php
    ...
    $query = "SELECT * from item where med_Id='$device_Id'";
...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="css/device_profile.css" />
    ...
    <div class="content">
     ...
     <main class="main-container">
        <div class="main-title">
          <p class="font-weight-bold">Medical Device Details</p>
        </div>
        ...
        <table>
            ...
            <tr>
                ...
                <td class="second"><?php echo $row['reorder']; ?></td>
            </tr>
            <tr><td colspan="2"><hr></td></tr>
            <tr>
                <td><label>Dosage : </label></td>
                <td class="second">50mg | 100mg</td>
            </tr>
            <tr><td colspan="2"><hr></td></tr>
            <tr>
                <td><label>Quantity : </label></td>
                <td class="second"><?php echo $row['category']; ?></td>
            </tr>
            <tr><td colspan="2"><hr></td></tr>
            <tr>
