...
<body>
            ...
            <div class="icon-container">
                <table>
                    <tr>
                        ...
                        <td id="fname"><p> <b>Name</b></p></td>
                        <td id="profile"> <i class="far fa-user-circle"></i></td>
                    </tr>
                </table>
        </div>
    </header>
    ...
    <div class="leftnavi">
        ...
        <div class="sub">
            <ul>
                <li> <button class="navibtn"> <b>  Over View</b> </button> </li>
                <li> <button class="navibtn"> <b> My Orders </b></button></li>
                <li> <button class="navibtn"> <b> Payment </b></button></li>
                <li> <button class="navibtn"> <b> Customer Support </b></button></li>
            </ul>
        </div>
    </div>
