           ...
           if($result2) 
           {
                  while($row2=mysqli_fetch_assoc($result2))
                  {
                   ...
                   ?>
                       ...
                       <div class="product">
                       <div class="image">
                           <a href="auth/landing_aboutmedicine.php?mid=<?php echo $row2['med_Id']; ?>"><img src="<?php echo str_replace('../', '', $row2['image']); ?>" alt="imge"></a>
                       </div>
                       <div class="namePrice">
                       ...
                       <div class="cartbtn1">
                           <a href="login.php"><button > Add to Cart </button></a>
                       </div>
                       <div class="cartbtn2">
                    ...
                    //  if not a medicine searched
                            ...
                            <div class="product">
                       <div class="image">
                           <a href="auth/landing_aboutitem.php?mid=<?php echo $row2['med_Id']; ?>"><img src="<?php echo str_replace('../', '', $row2['image']); ?>" alt="imge"></a>
                       </div>
                       <div class="namePrice">
                           <h3> <?php echo $row2['name']; ?> </h3>
...
?>
    ...
    // if the item is not medicine, tht means wellness, personal care, devices or others
            ...
            <!-- instock or outofstock -->
                ...
                <div class="image">
                    <?php if($row['category']=='Medicine'){ ?><a href="auth/landing_aboutmedicine.php?mid=<?php echo $row['med_Id']; ?>"> <img src="<?php echo str_replace('../', '', $row['image']); ?>" alt="imge"> </a>
                    <?php }else{ ?> <a href="auth/landing_aboutitem.php?mid=<?php echo $row['med_Id']; ?>"> <img src="<?php echo str_replace('../', '', $row['image']); ?>" alt="imge"> </a> <?php } ?>
                </div>
                <div class="namePrice">
                ...
                <div class="cartbtn2">
                    ...
                    <a href="auth/landing_aboutmedicine.php?mid=<?php echo $row['med_Id']; ?>"><button > Buy now</button></a>
                    <?php }else{ ?>
                    <a href="auth/landing_aboutitem.php?mid=<?php echo $row['med_Id']; ?>"><button > Buy now</button></a>
                    <?php } ?>
                </div>
